                            ...
                            <div className="lg:w-[65%] md:w-[55%] w-full flex flex-col gap-4">
                                ...
                                <div className="flex w-full flex-col gap-8 py-6 px-6 shadow shadow-md bg-white rounded-md">
                                    <div className="flex flex-col gap-4">
                                        <span className="lg:text-2xl md:text-xl text-lg font-bold w-full overflow-hidden">{product.name}</span>
                                        ...
                                        <div className="w-full flex flex-col gap-6">
                                            <div className="w-full md:flex-row flex flex-col gap-2">
                                                <div className="md:w-[40%] w-full flex flex-col gap-1">
                                                    ...
                                                    <span className="text-sm font-bold">{formatString(product.condition)}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="w-full md:flex-row flex flex-col gap-2">
                                                <div className="md:w-[40%] w-full flex flex-col gap-1">
                                                    ...
                                                    <span className="text-sm font-bold">
                                                        {product.return_policy ? product.return_policy : 'No return policy'}
                                                    </span>
                                                </div>
                            ...
                            <div className="lg:w-[35%] md:w-[45%] w-full flex flex-col gap-4">
                                <div className="w-full flex flex-col gap-3 py-5 md:px-8 px-4 rounded-md bg-white shadow shadow-md">
                                    <span className="md:text-2xl text-xl font-bold">
                                        {product.store.currency.symbol} {currencyFormat(product.price)}
                                    </span>
                                    {/* <Button
                                        type="submit"
                                ...
                                {product.vendor ? (
                                    <div className="w-full flex flex-col gap-3 py-5 md:px-8 px-4 rounded-md bg-white shadow shadow-md">
                                        <div className="flex gap-2">
                                            <div className="flex">
                                                <Imgix sizes="100vw" src="https://res.cloudinary.com/do2kojulq/image/upload/v1735426601/kudu_mart/profile_icon_yq3gnr.png" alt="avatar" width={60} height={60} className="w-[50px] h-[50px] rounded-full object-fit-cover" />
                                            </div>
