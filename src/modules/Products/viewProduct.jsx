                        ...
                        <div className="w-full flex md:flex-row flex-col gap-4">
                            <div className="lg:w-[65%] md:w-[55%] w-full flex flex-col gap-4">
                                <div className="flex w-full">
                                    <Imgix 
                                    src={'https://res.cloudinary.com/do2kojulq/image/upload/v1735426616/kudu_mart/watches_ez2zu2.png'} 
                                    sizes="100vw" width={800} height={500} alt='main-product' className="rounded-md" />
                                </div>
                                <div className="flex w-full overflow-x">
                                    <div className="flex w-full gap-2">
                                        <Imgix
                                            src={'https://res.cloudinary.com/do2kojulq/image/upload/v1735426616/kudu_mart/watches-1_dg8k2t.png'}
                                            sizes="100vw"
                                            width={185}
                                            height={100}
                                            alt="main-product"
                                        ...
                                        />
                                        <Imgix
                                            src={'https://res.cloudinary.com/do2kojulq/image/upload/v1735426624/kudu_mart/watches-2_d7v9lb.png'}
                                            sizes="100vw"
                                            width={185}
                                            height={100}
                                            alt="main-product"
                                        ...
                                        />
                                        <Imgix
                                            src={'https://res.cloudinary.com/do2kojulq/image/upload/v1735426623/kudu_mart/watches-3_ibggxm.png'}
                                            sizes="100vw"
                                            width={185}
                                            height={100}
                                            alt="main-product"
                                        ...
                                        />
                                        <Imgix
                                            src={'https://res.cloudinary.com/do2kojulq/image/upload/v1735426623/kudu_mart/watches-4_oso3vu.png'}
                                            sizes="100vw"
                                            width={185}
                                            height={100}
                                            alt="main-product"
