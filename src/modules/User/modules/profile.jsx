            ...
            <div className="grid grid-cols-1 md:grid-cols-2 p-6 gap-4">
                ...
                <div className="border rounded-lg">
                    ...
                    <div className="flex flex-col gap-2 p-4">
                        ...
                        <p className="text-gray-500 font-medium">{user.location ?
                    ...
                    <div className="p-4">
                        <button className="text-sm text-kudu-orange font-semibold underline" onClick={handleModal}>
                    ...
                    <div className="border rounded-lg">
                        ...
                        <div className="flex justify-between gap-2 p-4">
                            ...
                            {subscriptionPlan.length > 0 ?
                                <p className="flex">
                                    <span onClick={() => handleViewModal(subscriptionPlan[0])} className="text-underline cursor-pointer text-sm font-semibold text-kudu-orange">View Details</span>
                                </p>
                                :
                                <></>
                            }
