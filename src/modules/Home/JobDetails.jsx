        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 Justing">
                ...
                <div className="md:col-span-2">
                    <h1 className="text-2xl md:text-3xl font-semibold">Senior Tax Analyst</h1>
                    ...
                    {/* Company Description */}
                    <div className="mt-6">
                        <h2 className="text-xl font-semibold leading-loose">Company Description</h2>
                        <p className="text-gray-700 mt-2 leading-loose">
                            Kudu is currently seeking a highly motivated and experienced Senior
                            Tax Analyst to join our team. As a rapidly growing company, we are
                            looking for talented individuals who are committed to helping us
                            achieve our goals.
                        </p>
                    </div>
                    ...
                    {/* Job Description */}
                    <div className="mt-6">
                        <h2 className="text-xl font-semibold leading-loose">Job Description</h2>
                        <ul className="list-disc list-inside text-gray-700 mt-2 leading-loose space-y-2">
                            <li>Prepare U.S. indirect tax filings for Sales Tax and Use Tax.</li>
                            <li>Research, calculate, and report gross receipts and use tax.</li>
                            <li>Prepare reconciliations of U.S. indirect tax general ledger accounts.</li>
                    ...
                    <div className="mt-6">
                        ...
                        <ul className="list-disc list-inside text-gray-700 mt-2 space-y-2">
                            ...
                            <li>Experience with preparing complicated tax returns for corporate.</li>
                            <li>Detail-oriented and able to meet tight deadlines.</li>
                            <li>Advanced knowledge of Microsoft Excel and Word.</li>
                            <li>Experience in a Big-4 public accounting firm is preferred.</li>
                        </ul>
                    </div>

                    {/* Qualification */}
                    <div className="mt-6">
                        <h2 className="text-xl font-semibold leading-loose">Qualification</h2>
                        <ul className="list-disc list-inside text-gray-700 mt-2 space-y-2 leading-loose">
                            ...
                            <li>3+ years of U.S. tax experience in a public accounting firm.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 border rounded-lg">
                    ...
                    <p className="text-gray-600 text-sm">Fill the form to submit your application</p>
                    ...
                    <form className="mt-4 space-y-4">
                        ...
                        <div>
                            <label className="text-gray-700 text-sm">Attach CV/Resume</label>
                            <input
                                type="file"
                                className="w-full border p-4 rounded-md mt-4"
                                style={{ outline: "none" }}
                            ...
                            <small className="text-gray-500 text-xs">
                                Must be .txt, .docx, .doc, or .pdf (Max 2MB)
                            </small>
                        </div>
                        ...
                        <button className="bg-orange-500 text-white w-full mt-5 py-4 rounded-md hover:bg-orange-600">
                            Submit →
                        </button>
                    </form>
                </div>
