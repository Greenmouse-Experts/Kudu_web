    ...
    const principles = [
        {
            title: "Introduction",
            description:
                "At Kudu Mart, we prfioritize trust, safety, and customer satisfaction. These Terms and Conditions outline the rules governing the use of our platform to ensure a secure and enjoyable experience for all users.",
        },
        {
