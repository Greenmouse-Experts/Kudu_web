                    ...
                    >
                        ...
                        >
                            ...
                            {message.type !== "outgoing" && (
                                <Imgix
                                    src={'https://res.cloudinary.com/do2kojulq/image/upload/v1735426595/kudu_mart/profile_suv8ww.jpg'}
                                    alt="user"
                                    width={40}
                                    height={40}
                                    sizes="20vw"
                            ...
                            {message.type === "outgoing" && (
                                <Imgix
                                    src={'https://res.cloudinary.com/do2kojulq/image/upload/v1735426600/kudu_mart/profile_2_qeo1m8.png'}
                                    alt="user"
                                    width={40}
                                    height={40}
                                    sizes="20vw"
