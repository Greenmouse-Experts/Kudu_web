...
const AdminAdverts = ({ data, refetch }) => {
                    ...
                    <table className="w-full border-collapse">
                        <thead>
                            <tr className="text-black-600 text-md font-medium">
                                ...
                                <th className="py-6 px-4 text-left">Advert Name</th>
                                <th className="py-6 px-4 text-center">Advert Image</th>
                                <th className="py-6 px-4 text-left">Vendor Name</th>
                                <th className="py-6 px-4 text-left">Advert Category</th>
                        ...
                        <tbody>
                            {data.map((ad, index) => (
                                ...
                                >
                                    ...
                                    <td className="py-6 px-4 text-left relative">
                                        <Menu placement="left">
                                            <MenuHandler>
                                                <button
                                            ...
                                            <MenuList>
                                                <MenuItem className="flex flex-col gap-3">
                                                    <span className="cursor-pointer w-full" onClick={() => navigate(`edit/${ad.id}`)}>
                                                        Edit
                                                    </span>
                                                </MenuItem>
                                                <MenuItem className="flex flex-col gap-3">
                                                    <span className="cursor-pointer w-full" onClick={() => handleDeleteModal(ad.id)}>
                                                        Delete Advert
                                                    </span>
                                                </MenuItem>
                                            </MenuList>
