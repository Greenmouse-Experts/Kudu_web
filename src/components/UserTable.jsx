...
const UserTable = ({ data, totalData, refetch }) => {
    ...
    const toggleUserStatus = (userId, currentStatus) => {
        console.log(`🔄 [UserTable] Attempting to toggle status for user ID: ${userId}, current status: ${currentStatus}`);
        ...
        const confirmToggle = () => {
            ...
            mutate({
                ...
                headers: true,
                onSuccess: (response) => {
                    console.log(`✅ [UserTable] Successfully ${action}d user:`, response.data);
                            ...
                            actions={[
                                {
                                    label: (row) => {
                                        ...
                                        return row.status === 'active' ? 'Suspend Customer' : 'Unsuspend Customer';
                                    },
                                    onClick: (row) => {
                                        if (!updatingUsers.has(row.id)) {
