const StatCard = ({ number, label, iconColor, IconComponent, colorGradient, cronTop, cronTopIcon,cronAnalytics }) => {
    ...
    return (
        <div className="bg-white rounded-md shadow-md py-6 px-4 w-full flex items-center justify-between" style={style}>
            ...
            <div
                className={`w-10 h-10 rounded-full flex items-center justify-center bg-kuduLightGray`}
            >
                {IconComponent}
            </div>
        </div>
