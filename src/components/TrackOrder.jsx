...
const TrackOrder = ({ userType, orderId, status, admin, refetch }) => {
    ...
    const handleNext = () => {
        ...
        if (status === 'shipped' && statusArr[statusIndex + 1] === 'delivered' && userType) {
    ...
    const updateOrderStatus = (code = null) => {
        ...
        mutate({
            ...
            data: requestData,
            onSuccess: (response) => {
                console.log("✅ [TrackOrder] Order status updated successfully:", response.data);
                if (code) {
                    ...
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
                        ...
                        <div className="p-6">
                            <p className="text-sm text-gray-600 mb-4">
                                Please enter the delivery confirmation code to mark this order as delivered.
                            </p>
                            <div>
