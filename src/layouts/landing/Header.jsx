                    ...
                    <Menu>
                      <MenuHandler>
                        <div className="flex items-center relative">
                          ...
                          <div className="absolute -top-2 -right-1 w-4 h-4 rounded-full flex justify-center items-center bg-kuduOrange text-white">
                        ...
                        {arrOptions.map((options, index) =>
                          options.modal ? (
                            ...
                            >
                              {options.value}
                              {options.info > 0 && (
                                <div className=" w-4 h-4 rounded-full flex justify-center items-center bg-kuduOrange text-white">
