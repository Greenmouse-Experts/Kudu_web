        ...
        <div className="bg-white shadow-md fixed w-full z-[95] py-1 lg:py-0 md:py-0">
            <div className="w-full flex items-center justify-between xl:px-80 lg:px-36 md:px-4 px-5">
                ...
                <div className="hidden md:flex items-center space-x-5 py-1">
                            ...
                            <Menu>
                                <MenuHandler>
                                    <span className='flex items-center cursor-pointer gap-1'>
                                        ...
                                        <span className="mr-1 text-[13px] font-[500] mt-[4px]"> Register/Login </span>
                                    </span>
                                </MenuHandler>
                                <MenuList>
                            ...
                            <Menu>
                                <MenuHandler>
                                    <span className='flex items-center cursor-pointer gap-1'>
                                        ...
                                        <span className="mr-1 text-[13px] font-[500] mt-[4px]"> {user.firstName} {user.lastName} </span>
                                    </span>
                                </MenuHandler>
                                <MenuList>
                    ...
                    <Link to={'/auction'} className="bg-kuduDarkGrey text-white py-2 px-4 rounded-lg">
