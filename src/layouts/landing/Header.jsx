                    ...
                    <header className="w-full">
                        ...
                        <div className="w-full flex items-center justify-between py-4 xl:px-40 md:px-28">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                {user &&
                                    <>
                                        <Link to="/cart" className="flex items-center text-black gap-1">
                                        ...
                                        <Link to="/messages" className="text-black flex items-center gap-1">
                                        ...
                                        <Menu>
                                            <MenuHandler>
                                                <span className='flex items-center cursor-pointer gap-1'>
                                                    ...
                                                    <span className="mr-1 text-[15px] font-[500] mt-[4px]"> Register / Login </span>
                                                </span>
                                            </MenuHandler>
                                            <MenuList>
                                                {authOptions.map((options, index) => (
                                                    <Link to={`/${options.slug}`}
                                        ...
                                        <Menu>
                                            <MenuHandler>
                                                <span className='flex items-center cursor-pointer gap-1'>
                                                    ...
                                                    <span className="mr-1 text-[15px] font-[500] mt-[4px]"> {user.firstName} {user.lastName} </span>
                                                </span>
                                            </MenuHandler>
                                            <MenuList>
                                                {arrOptions.map((options, index) => (
                                                    options.modal ?
                                                        <span className="block px-4 py-2 text-sm text-gray-700 hover:outline-none cursor-pointer" key={index}
