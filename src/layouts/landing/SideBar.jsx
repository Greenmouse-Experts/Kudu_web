    ...
    return (
        <div className={`h-full bg-white rounded-md flex-col w-full lg:hidden md:hidden flex overflow-auto bg-mobiDarkCloud transition-all mb-10`}>
            ...
            <div className="px-4 py-6">
                <Link to={'/app/settings'} onClick={() => onSelected(false)} className={`flex items-center py-2 px-4 h-[57px] rounded-lg transition`}>
                    <i className={`fas fa-cog mr-3`}></i>
                    <span className="text-sm font-[500]">Settings</span>
                </Link>
                <a to="#" onClick={() => onSelected(false)} className={`flex items-center py-2 px-4 h-[57px] rounded-lg text-red-500 hover:bg-kuduLightGray  transition`}>
