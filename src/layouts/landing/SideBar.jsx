    ...
    return (
        <div className={`h-full bg-white rounded-md flex-col w-full lg:hidden md:hidden flex overflow-auto bg-mobiDarkCloud transition-all mb-10`}>
            ...
            <nav className="px-4 space-y-5">
                <Link to="/cart" className="flex items-center py-2 px-4 text-black gap-1">
                ...
                <Link to="/messages" className="flex items-center py-2 px-4 text-black gap-1">
                ...
                <a to="#" className="flex items-center py-2 px-4 text-black gap-1">
                ...
                <Accordion open={open} className="border-b border-mobiSilverDivider">
                    ...
                    <AccordionBody>
                        <div className="space-y-2">
                            {authOptions.map((option, index) => (
                                <Link key={index} to={`/${option.slug}`} className="flex items-center py-2 px-6 rounded-lg">
                ...
                <Link to={'/auction'} className="bg-kuduDarkGrey text-white flex items-center py-2 px-6 items-center gap-1 rounded-lg">
                    <span className="text-center w-full text-sm font-[500]">Auction</span>
                </Link>
                <Link to={'/post-product'} className="bg-kuduOrange text-white py-2 px-6 flex items-center rounded-lg">
            ...
            <div className="px-4 py-6">
                <Link to={'/app/settings'} className={`flex items-center py-2 px-4 h-[57px] rounded-lg transition`}>
                    <i className={`fas fa-cog mr-3`}></i>
                    <span className="text-sm font-[500]">Settings</span>
                </Link>
                <a to="#" className={`flex items-center py-2 px-4 h-[57px] rounded-lg text-red-500 hover:bg-kuduLightGray  transition`}>
