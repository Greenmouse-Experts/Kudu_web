    ...
    return (
        <div className={`h-full bg-white rounded-md flex-col w-full md:w-[22%] relative md:fixed flex overflow-auto bg-mobiDarkCloud transition-all mb-10`}>
            ...
            <nav className="px-4 space-y-5">
                ...
                <a to="#" className={`flex items-center py-2 px-4 h-[57px] rounded-lg hover:bg-kudu-light-gray  text-mobiRomanSilver transition`}>
                    <i className="mr-3">
                ...
                <a href="#" className={`flex items-center py-2 px-4 h-[57px] rounded-lg hover:bg-kudu-light-gray  text-mobiRomanSilver transition`}>
                    <i className="mr-3">
            ...
            <div className="px-4 py-6">
                ...
                <a href="#" onClick={() => onSelected(false)} className={`flex items-center py-2 px-4 h-[57px] rounded-lg text-red-500 hover:bg-kudu-light-gray  transition`}>
