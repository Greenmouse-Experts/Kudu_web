            ...
            <div className={`bg-kuduMade h-full px-6 pt-6 rounded-md flex-col w-full md:w-[20%] relative md:fixed flex overflow-auto bg-mobiDarkCloud transition-all mb-10`}>
                <div className={`h-full bg-white pb-20 rounded-md flex-col w-full md:w-[21%] relative md:fixed flex overflow-auto bg-mobiDarkCloud transition-all mb-10`}>
                    ...
                    <nav className="px-10 space-y-5">
                        ...
                        <div className='relative'>
                            ...
                            {dropdownStates.products && (
                                <div className="absolute left-0 mt-2 w-full bg-white rounded-md shadow-lg py-3 z-10">
                                    ...
                                    <Link to={'#'} onClick={() => handleChildren('')} className="block px-4 py-4 text-sm text-gray-700 hover:bg-gray-100">Categories</Link>
                                </div>
                            )}
                        </div>
                        ...
                        <Link to={'/admin/orders'}  className={`flex items-center px-4 h-[57px] rounded-lg transition ${
                            isActive('/admin/orders') ? 'bg-[#FFF1E9] text-black' : 'text-[#7F7F7F] hover:bg-gray-100'
                        }`}>
                            <i className="mr-5">
                        ...
                        <Link to={'/admin/transactions'}  className={`flex items-center px-4 h-[57px] rounded-lg transition ${
                            isActive('/admin/transactions') ? 'bg-[#FFF1E9] text-black' : 'text-[#7F7F7F] hover:bg-gray-100'
                        }`}>
                            <i className="mr-5">
                        ...
                        <Link to={'/admin/sublevel'}  className={`flex items-center px-4 h-[57px] rounded-lg transition ${
                            isActive('/admin/sublevel') ? 'bg-[#FFF1E9] text-black' : 'text-[#7F7F7F] hover:bg-gray-100'
                        }`}>
                            <i className="mr-5">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
