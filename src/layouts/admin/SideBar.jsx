                ...
                <div className={`h-full bg-white pb-20 rounded-md flex-col w-full md:w-[21%] relative md:fixed flex overflow-auto bg-mobiDarkCloud transition-all mb-10`}>
                    ...
                    <nav className="px-10 space-y-5">
                        ...
                        className={`flex items-center px-4 h-[57px] rounded-lg transition ${
                            isActive('/admin/dashboard') ? 'bg-gray-200 text-black' : 'text-[#7F7F7F] hover:bg-gray-100'
                        }`}>
                        ...
                        <Link to={'/admin/users'}
                        className={`flex items-center px-4 h-[57px] rounded-lg transition ${
                            isActive('/admin/users') ? 'bg-gray-200 text-black' : 'text-[#7F7F7F] hover:bg-gray-100'
                        }`}>
                            <i className="mr-5">
                        ...
                        <Link  to={'/admin/products-sell'}
                        className={`flex items-center px-4 h-[57px] rounded-lg transition ${
                            isActive('/admin/products-sell') ? 'bg-gray-200 text-black' : 'text-[#7F7F7F] hover:bg-gray-100'
                        }`}>
                            <i className="mr-5">
